...
An open dataset of **researched guitar tones for 1,200+ famous songs** — the original gear (guitar, amp, pedals) and starting amp settings (gain, bass, mid, treble, presence, reverb) behind iconic riffs, with source citations.
